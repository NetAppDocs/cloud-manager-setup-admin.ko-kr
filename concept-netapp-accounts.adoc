...
각 NetApp 계정은 최대 Cloud Volumes ONTAP 시스템 수로 제한됩니다. https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/concept-licensing.html#max-number-of-systems["이 제한에 대해 자세히 알아보십시오"^]
